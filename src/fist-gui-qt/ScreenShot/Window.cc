  ...
  namespace screenshot
  {
    ...
    void RegionSelector::_draw_selection_rectangle(QPainter &painter)
    {
      if (!this->_desktop_clear.isNull())
      {
        ...
        QRect foutre;
        painter.drawText(this->_selection_rectangle, Qt::AlignBottom | ((this->_selection_origin.x() < this->_selection_rectangle.right()) ? Qt::AlignLeft : Qt::AlignRight), txtSize, &foutre);
        ELLE_LOG("foutre: %s", foutre);
